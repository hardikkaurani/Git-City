      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <div className="mt-14 border-[3px] border-lime/20 bg-lime/[0.03] p-8">
          ...
          <div className="flex justify-center">
            <Link href="/hire/hardikkaurani" className="btn-press border-[3px] border-lime/30 px-6 py-3 text-xs text-lime transition-colors hover:border-lime/50 hover:bg-lime/5">
        ...
        <div className="mt-14 text-center pb-8">
          <p className="text-xs text-dim normal-case">
            Questions?{" "}
            <a href="mailto:hardikkaurani1@gmail.com" className="text-lime transition-colors hover:text-cream">
