...
insert into sky_ads (id, brand, text, description, color, bg_color, link, vehicle, priority) values
  ('gitcity', 'Git City', 'GIT CITY ★ YOUR CODE, YOUR CITY ★ GIT CITY', 'A city built from GitHub contributions. Search your username and find your building among thousands of developers.', '#f8d880', '#1a1018', 'http://localhost:3001', 'plane', 100),
  ('hardik', 'Hardik Kaurani', 'HEY, I BUILD THIS! → HARDIKKAURANI', 'Full-stack dev who builds weird and cool stuff. This city is one of them.', '#c8e64a', '#1a1018', 'https://github.com/hardikkaurani', 'plane', 90),
  ...
  ('advertise', 'Sky Ads', 'ADD YOUR AD HERE', 'Want your brand flying over Git City? Planes, blimps, your colors. Get in touch!', '#f8d880', '#1a1018', 'mailto:hardikkaurani1@gmail.com?subject=Git%20City%20Sky%20Ad', 'plane', 10);
